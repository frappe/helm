...
Download and edit values.yaml for frappe related mariadb config.
  Source : [Mariadb Config Yaml](https://raw.githubusercontent.com/bitnami/charts/master/bitnami/mariadb/values.yaml)
<details>
  <summary>Mariadb template yaml - click to expand</summary>
...
helm repo update
helm install mariadb -n mariadb bitnami/mariadb -f values.yaml
```
