...
| `persistence.apps.enabled`                            | Enable volume persistence for apps.                                                                                        | `true`                                   |
| `persistence.apps.existingClaim`                      | Use existing RWX persistence volume claim for apps.                                                                        | `nil`                                    |
| `persistence.apps.size`                               | Size of volume to be created for apps.                                                                                     | `2Gi`                                    |
| `persistence.apps.storageClass`                       | Storage class to use to create volume for apps                                                                             | `nil`                                    |
